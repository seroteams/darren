...
## Changes
- New file: `docs/reports/2026-07-05-live-data-audit.md` — what's healthy, what's disconnected, what's parked.
...
1. **Read it** — open [docs/reports/2026-07-05-live-data-audit.md](../../../reports/2026-07-05-live-data-audit.md). You should understand every finding without asking me. ❌ Not OK if any section needs a translator.
