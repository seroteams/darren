...
## ✅ GREEN-LIT 2026-07-29 — Carl signed off on the run-2 output (commit `738c276f`)

Approved from the before-and-after questions in chat, evidence-first. Two gate hard fails were left
open on purpose, both in stages this phase never touched, and both parked in
[plan.md](plan.md) with what is known about them.
