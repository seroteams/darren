...
Carl walked all three scenarios on his own account: the feels-off walk-in card with one button,
the bi-weekly with two, and the feels-off recap carrying last time's actions above the lock-in.
