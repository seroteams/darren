...
**Status:** P0 ✅ · P1 ✅ · P2 ✅ · P3 built, awaiting Carl's sign-off
...
| P3 | [One namespace per concept](phase-3-namespaces.md) | no | identical computed-value map | ✅ built (partial — 6 files lane-blocked), awaiting sign-off |
