...
| 2 | Let it mint under pressure | Relax the early-bail so a *genuine new thread* still mints when the person has been opening up — while keeping the drill cap for true same-point over-drilling. Proven with ONE paid gate case. | ⬜ |
...
**Phase 2 is next** — relax the mint-bail so a genuine new thread follows even under drill pressure; the one paid gate case (~$0.35) proves the metric moves without new leakage. Awaiting Carl's "build phase 2".
