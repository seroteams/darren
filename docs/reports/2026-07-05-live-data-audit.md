...
| ~12 folders sit in `docs/workstreams/` as "active" — some may be truly finished | `docs/workstreams/` | Phase 4 cross-checks and moves closed ones to `done/` |
...
*Produced by the live-data-cleanup plan ([docs/archive/done/live-data-cleanup/plan.md](../archive/done/live-data-cleanup/plan.md)). Baseline before any change: `npm test` 67/67 PASS (2026-07-05).*
