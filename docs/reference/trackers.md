...
| **docs/reports/sero-how-it-works.html** | Manual founder-facing changelog — the story of what shipped, refreshed by hand at each phase close. Does not self-update. | STATUS.md |
