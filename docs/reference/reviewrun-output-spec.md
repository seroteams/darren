...
**Audit pointer:** [`plans/log-fix-audit.md`](../archive/plans/log-fix-audit.md) — master ID table
...
*(Omit rows with no match. Read [`log-fix-audit.md`](../archive/plans/log-fix-audit.md) for full table.)*
...
Before phase 2, skim [`log-fix-audit.md`](../archive/plans/log-fix-audit.md) (or grep symptom keywords). When a signal, hypothesis, or note-fix matches a row, tag it.
