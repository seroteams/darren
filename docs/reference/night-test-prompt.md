...
Produce a **clean, scannable HTML dashboard** at `docs/reports/2026-07-07-night-test-report.html` — this is the thing Carl opens first, so make it genuinely nice (Carl is a visual thinker; show, don't wall-of-text). Self-contained, plain language, 14px+ text. Include:
...
Keep `docs/reports/2026-07-07-night-test-report.md` too as the raw log the HTML is built from.
