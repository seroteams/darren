...
- Everything else is a log (PROGRESS.md — append-only decisions), a feature (the /tasks board
  ...
  continue prompt"), or a story (`docs/reports/sero-how-it-works.html`, the hand-refreshed founder
  changelog).
...
**Guardrails** (`docs/reference/guardrails.md`): every request from Carl is checked against five drift
