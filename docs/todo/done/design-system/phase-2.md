...
2. **Supersede banner** — one line at the top of `docs/archives/plans/DESIGN.md` pointing to the
   root `DESIGN.md`.
...
**Green light = commit + close out** (move folder to `docs/todo/done/`, STATUS.md rolls on).
