...
- [ ] The table lists real rows from Phase 1, newest first, with When/Env/Who/Where/What/Status filled — each row shows a Local / Live tag.
...
2. **A row tells the story at a glance** — pick a row. Without clicking in, you can read *whether it was local or live*, *who* hit it, *where*, *what* broke, and *when*. ❌ Not OK if you can't tell what happened from the row.
