...
1. **Spec points at real code** — open [docs/sero-prompt-improvement-spec.md](../../sero-prompt-improvement-spec.md), find the final-evaluation section. It should talk about `engagement_read` and what to change it into. ❌ Not OK if `disengagementSignal` still appears anywhere as a field to rename.
