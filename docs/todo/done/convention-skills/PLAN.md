...
**Driver:** Carl
**Created:** 2026-06-24
**Tracks:** the bigger plan in [../../../archives/prototype-to-production/✓002-convention-skills/00-phase-overview.md](../../../archives/prototype-to-production/✓002-convention-skills/00-phase-overview.md). When this is done + approved, update that effort's `PROGRESS.md` (Phase 002 → `done`).
