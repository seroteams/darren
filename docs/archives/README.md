...
- `prototype-to-production/`: the completed 001–008 build track (phase overviews, QA checklists, `PROGRESS.md`, `009-ready-to-share.md`). All eight phases done + signed off; superseded by the active `docs/pre-go-live/` track. Live links (CLAUDE.md, TRACKERS.md, pre-go-live/README, 009-ready-to-share, done/{convention-skills,backend-api-v1}) repointed here. The `✓` prefix was stripped from the top folder; inner `✓NNN-*` phase folders kept their prefix.
