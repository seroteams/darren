...
- **[repo-tidy](../../todo/repo-tidy/PLAN.md) finished** — Phases 3–4 (split `sessions.controller`,
  admin TypeScript pilot) + the parked naming pass and hermetic-test fix.
- **[tracker-consolidation](../../todo/tracker-consolidation/PLAN.md) finished** — Phases 2–4, starting
  by committing the Phase 1 work (`docs/TRACKERS.md`) that's currently sitting uncommitted.
