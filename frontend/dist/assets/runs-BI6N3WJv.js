import{i as g,s as l,u as f,p as b,e as p,S as u}from"./index-D93BFPRu.js";import{r as v}from"./time-C7qwLehH.js";import{S as w}from"./star-6WkPOSOg.js";function x(e){const t=e.ctx||{},n=[];t.name&&n.push(t.name),t.role&&n.push(t.seniority?`${t.role}, ${t.seniority}`:t.role),t.meetingType&&n.push(t.meetingType);const i=v(e.lastSeenAt);return i&&n.push(i),p(n.length?n.join(" · "):e.headline||"Untitled 1:1")}const A=async(e,{setState:t})=>{const n=`
