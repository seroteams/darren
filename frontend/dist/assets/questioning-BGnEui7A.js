import{I as X,f as z,S as m,F as W,C as T,J as Z,K as ee,G as te,p as ne,H as se}from"./index-D93BFPRu.js";import{c as ae,o as ie}from"./orb-BvJ65ChT.js";import{c as oe,A as re,a as ce}from"./axes-DGXdW7yE.js";import{r as j,s as H}from"./reveal-CdKVaBU1.js";import{C as le}from"./copy-eqjIEJPA.js";let I=null;async function ge(u,{store:a,setState:r}){var M,O;u.innerHTML=`
  ...
  `;const h=u.querySelector(".turn-label"),P=u.querySelector(".question-session-ctx"),q=u.querySelector(".question-host");X(P,a.ctx||{});const _=u.querySelector(".question-session-notes"),$=String(((M=a.ctx)==null?void 0:M.notes)||"").replace(/\s*\n+\s*/g," ").trim();$&&(_.textContent=`“${$}”`,_.hidden=!1);const E=u.querySelector(".thinking-host"),Y=u.querySelector(".axes-host"),w=u.querySelector(".footer-host"),L=oe({celebrate:!1});L.renderInitial((O=a.axes)!=null&&O.length?a.axes:re.map(o=>({id:o,score:ce[o],lastDelta:0,historyLen:0}))),Y.appendChild(L.el);let g=null,c=null;function R(){g&&(g.close(),g=null),c&&(document.removeEventListener("keydown",c),c=null)}u.querySelector(".js-save-exit").addEventListener("click",async()=>{await z({message:"Skip the remaining questions and open the briefing now? Any unanswered questions will be dropped.",confirmLabel:"Open briefing",cancelLabel:"Keep questioning"})&&(R(),r({stage:m.BRIEFING}))});async function A({prefill:o=null}={}){var U;q.innerHTML="",E.innerHTML="",w.innerHTML="";const n=await W(a.sessionId);if(n.done){if((U=n.agenda)!=null&&U.summary&&n.agenda.covered==null){K(n.agenda);return}r({stage:m.EVAL});return}h.textContent=`Question ${n.turn} of ${n.total}`;const i=n.question;a.currentQuestion=i;const p=n.scripted||a.scripted||null,v=n.scripted?n.scripted.answer:p?p.answers[i.alias]:void 0,y=!!p&&v!=null,N=/thread_follow|drill|follow_up/i.test(i.alias||""),e=document.createElement("div");e.className="card questioning-card space-y-4 reveal",e.innerHTML=`
