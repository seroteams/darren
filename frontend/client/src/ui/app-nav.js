...
const ICON = {
  ...
  todo: icon(`<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>`),
};
...
const LINKS = [
  ...
  { key: "todo", label: "Build plan", stage: STAGES.TODO, icon: ICON.todo },
];
...
export function createAppNav({ setState, resetSession } = {}) {
  ...
  const onNav = {
    ...
    todo: () => setState && setState({ stage: STAGES.TODO }),
