...
**PG1–PG5 ✅ done** (Runs list, reopen, rate a 1:1, Team auto-built + "Past 1:1s" relabel, and the per-person
page with "Since last time" + "Prep next 1:1" — all signed off, committed to `main`). **PG6 (Superadmin
gate) is next — not yet broken down.** No paid runs.
