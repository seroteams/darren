...
const DATA = [
  ...
  { num: "003", name: "Make the code safer", tag: "TypeScript Conversion",
    ...
    steps: [
      ...
      { f: "Convert piece by piece", m: "Convert the whole backend outside-in — engine first, then the API server, then the command-line tool — keeping every test green at each step.", have: "Engine done; API server + CLI converting",
        auto: "Run `npm test` — expect 30/30 after each converted piece.", eye: "In progress: engine fully done, API server about half. App + command-line still behave the same.", s: "doing" },
  ...
  { num: "004", name: "A proper engine room", tag: "Backend API v1",
    ...
    steps: [
      { f: "Draw the menu of services", m: "List every service and write the official menu (contract): what you can ask for and what you get back.", have: "A written service menu",
        auto: null, eye: "Once built: the contract doc lists every request and its response shape." },
  ...
  { num: "007", name: "The customer app", tag: "Frontend App",
    ...
    steps: [
      { f: "Stand up the new app", m: "Create the new customer app and its build setup — the shell the experience lives in.", have: "New app running",
        auto: "Once built: the new app builds and runs.", eye: "Once built: the app opens in the browser." },
      { f: "Build register and login screens", m: "The actual screens a new customer sees.", have: "Register and login screens",
        auto: null, eye: "Once built: both screens appear correctly." },
      { f: "Wire the screens to the backend", m: "Connect the screens to the secure backend so signup and login really work and the app remembers you.", have: "Screens that really work",
        auto: null, eye: "Once built: register a new company, log in, reach the signed-in screen; a refresh keeps you logged in." },
      { f: "A simple home screen", m: "A minimal home showing the company name and a button to start a prep run — proves the loop.", have: "A home screen",
        auto: null, eye: "Once built: the home shows your company name and a start button." },
    ],
