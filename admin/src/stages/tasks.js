...
const KB_SEED = [
  { col: "doing", lane: "Agent", title: "Agent-native codebase", note: "P2 (fix stale agent maps) green-lit 2026-07-08. Next: P1 offline cassette replay — whole pipeline verifiable for $0. Run order 2→1→3→4→5." },
