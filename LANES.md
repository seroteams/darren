...
| c91a58a9 | Coach hints that move with the meeting | docs/plans/doing/coach-hints-live/, backend/api/services/sessions/sessions.service.ts, backend/api/services/sessions/sessions.service.test.ts, backend/engine/questions.test.ts, backend/engine/reconcile-queue.test.ts, backend/engine/queue-manager.ts, backend/engine/queue-manager.test.ts, backend/api/services/sessions/session-streams.ts, content/prompts/plan-turn.md | 2026-07-31 |
| 78d09803 | Action review placement (offer, don't gate) | docs/plans/doing/action-review-placement/, admin/src/stages/questioning.js, admin/src/stages/questioning-ready.ts, admin/src/stages/questioning-ready.test.ts, admin/src/ui/promise-checkin.ts, admin/src/ui/promise-checkin.test.ts, admin/src/styles/design/promise-checkin.css | 2026-07-31 |
| 4946b27d | No-dead-wires audit fixes (notes QA rule, prompt injection, leak screen) | backend/api/services/sessions/notes-format.ts, backend/api/services/sessions/notes-format.test.ts, backend/api/services/sessions/plan-turn-inputs.ts, backend/api/services/sessions/plan-turn-inputs.test.ts, backend/api/services/sessions/session-streams.ts, backend/api/services/persona-runs/persona-runs.runner.ts, backend/engine/prompt-utils.ts, backend/engine/prompt-utils.test.ts, backend/engine/messages.ts, backend/engine/messages.test.ts, backend/engine/reviewer.ts, backend/engine/serve-checks.ts, backend/engine/serve-checks.test.ts | 2026-07-31 |
