...
| 5d716aaf | Coach panel Phase 1 — questioning split + coach panel UI | docs/plans/doing/coach-panel/, admin/src/stages/questioning.js, admin/src/ui/coach-panel.ts, admin/src/ui/coach-panel-state.ts, admin/src/ui/coach-panel-state.test.ts, admin/src/styles/coach-panel.css | 2026-07-19 |
