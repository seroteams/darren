...
| 5d716aaf | Coach panel Phase 3 — rationale arc gate (golden-checks) | docs/plans/doing/coach-panel/, backend/engine/golden-checks.ts, backend/engine/golden-checks.test.ts | 2026-07-19 |
