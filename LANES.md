...
| c91a58a9 | Coach hints that move with the meeting | docs/plans/doing/coach-hints-live/, backend/api/services/sessions/sessions.service.ts, backend/api/services/sessions/sessions.service.test.ts, backend/engine/questions.test.ts, backend/engine/reconcile-queue.test.ts, backend/engine/queue-manager.ts, backend/engine/queue-manager.test.ts, backend/api/services/sessions/session-streams.ts | 2026-08-01 |
