...
|---------|------|-------|---------|
| 82796893 | Design consolidation P2 (auth + member) | docs/plans/doing/design-consolidation/, STATUS.md, admin/src/ui/, admin/src/stages/, frontend/src/, admin/src/styles/design/, admin/src/styles/coach-panel.css | 2026-07-23 |
