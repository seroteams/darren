...
| 85204553 | Planner prompt trim (say each rule once) | docs/plans/doing/planner-prompt-trim/, content/prompts/plan-turn.md, scripts/lint-prompt-size.js | 2026-08-02 |
| bdcfa33c | Run review: latest inputs + workflows | admin/src/ui/review-serialize.js, admin/src/ui/review-serialize.test.ts, admin/src/stages/review-run.js, backend/engine/run-projections.ts, backend/engine/run-projections.test.ts, backend/api/services/runs/runs.repo.ts | 2026-08-02 |
