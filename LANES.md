...
| 85204553 | Planner prompt trim (say each rule once) | docs/plans/doing/planner-prompt-trim/ | 2026-07-31 |
| 7cf4af57 | Regression rerun board | docs/plans/doing/regression-rerun-board/, backend/api/services/regression-runs/, backend/api/services/engine-job-slot.ts, backend/api/services/engine-job-slot.test.ts, backend/engine/regression-judge.ts, backend/engine/regression-judge.test.ts, admin/src/stages/regression.js, admin/src/stages/regression-rows.ts, admin/src/stages/regression-rows.test.ts, backend/api/server.ts, admin/src/ui/app-nav.js, shared/api.js | 2026-07-31 |
