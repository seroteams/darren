...
const { buildPipelineStatus } = require("./engine/pipeline-lock");
const { reviewSession: reviewLexiconSession } = require("./engine/lexicon-reviewer");
const { loadIntroQueue } = require("./engine/intro-queue");
const { ensureRoleProfile } = require("./engine/role-profile");
const { NOTES_DIR, ROOT } = require("./engine/paths");
...
const { collectRunRating } = require("./engine/cli/run-rating");
