...
export interface TranscriptEntry {
  ...
  unbooked_signal?: Array<{ axis: string; raw: number; booked: number; reason: string }>; // planner-held signal: clampToSignature overflow (off_signature/empty_signature/clamped) + shallow-gate zeroing (shallow_zeroed; protected positives are booked, not held — better-reads P2)
}
