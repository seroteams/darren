...
function createWebSession(ctx: MeetingContext, introQueue: Question[], orgId: string | null = null, userId: string | null = null, personId: string | null = null, totalBudget: number = TOTAL_BUDGET): Session {
