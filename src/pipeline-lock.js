...
const PATH_META = {
  ...
  "src/generate.js": { tier: "engine", stageLabel: "Focus points" },
  "src/preparation.js": { tier: "engine", stageLabel: "Preparation" },
  "src/question-generator.js": { tier: "engine", stageLabel: "Question bank" },
  "src/queue-manager.js": { tier: "engine", stageLabel: "Questioning (planner)" },
  "src/reviewer.js": { tier: "engine", stageLabel: "Evaluation" },
  "src/axes.js": { tier: "engine", stageLabel: "Axis scoring" },
  "src/questions.js": { tier: "engine", stageLabel: "Questions" },
  "src/opener.js": { tier: "engine", stageLabel: "Openers" },
  "src/intro-queue.js": { tier: "engine", stageLabel: "Intro queue" },
  "src/meeting-arcs.js": { tier: "engine", stageLabel: "Meeting arc" },
  "src/meeting-types.js": { tier: "engine", stageLabel: "Meeting types" },
  "src/lexicon.js": { tier: "engine", stageLabel: "Lexicon" },
  "src/ai-client.js": { tier: "engine", stageLabel: "AI client" },
  "src/models.js": { tier: "engine", stageLabel: "Models" },
  "src/lexicon/review-core.js": { tier: "engine", stageLabel: "Lexicon review" },
  "src/lexicon/candidates-io.js": { tier: "engine", stageLabel: "Lexicon candidates" },
  "frontend/server/sessions.js": { tier: "engine", stageLabel: "Sessions" },
  "frontend/server/session-persistence.js": { tier: "engine", stageLabel: "Session persistence" },
  "frontend/server/handlers/start.js": { tier: "engine", stageLabel: "Start" },
  "frontend/server/handlers/focus-points.js": { tier: "engine", stageLabel: "Focus points" },
  "frontend/server/handlers/preparation.js": { tier: "engine", stageLabel: "Preparation" },
  "frontend/server/handlers/bank.js": { tier: "engine", stageLabel: "Question bank" },
  "frontend/server/handlers/plan.js": { tier: "engine", stageLabel: "Questioning (planner)" },
  "frontend/server/handlers/question.js": { tier: "engine", stageLabel: "Question" },
