...
| [ia-consistency](docs/plans/doing/ia-consistency/plan.md) | P1 ✅ (3 nav/IA rules → DESIGN.md) + P2 ✅ (`run-detail.ts` recap names the person + breadcrumb; role-aware back) green-lit 2026-07-21. P3 (person-detail) next. [board](https://claude.ai/code/artifact/f6bced93-814a-460c-b5f5-590491d960cc) |
