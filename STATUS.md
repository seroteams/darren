...
> ### 🔨 [ux-audit-fixes](docs/plans/doing/ux-audit-fixes/plan.md) — ALL 5 PHASES BUILT + PUSHED LIVE 2026-07-17. Awaiting Carl's walk.
> The recovered 2026-07-14 UX audit → a 5-phase plan, now fully built and shipped. **P1 return path ✅ green-lit.** **P2 right doors/roles ✅ green-lit.** **P3 one language ✅ self-signed** — one "1:1" noun everywhere, human stage names, discard dialog, member voice, VOICE.md. **P4 returns measurable ✅ self-signed** — `report-returns.ts` (verified against the real local DB); M10 already-built; derived from existing tables, no migration. **P5 craft batch ✅ 7/7** — M5 setup counter no longer lies + top-bar overflow fixed · M6 one blue action, Delete → ⋯ · M8 clickable Team cards · M11 invite sheet (no window.prompt) · M12 account sheet + change-password (**verified end-to-end over HTTP**) · X1 "prep rating" · M15 phone rows. **M5/M6/M8/M12 verified live.** **Post-walk fixes:** the 2-hour prep TTL bug → 7 days (was killing overnight preps); person-page "Start 1:1 with X" CTA enlarged full-width. Suite **154/154**, typecheck clean, both build; **zero paid runs**. **▶ Your move:** walk P3/P4/P5 on the live site when you like; the editable name/company on the account sheet is a thin follow-up. Live board: https://claude.ai/code/artifact/b5f23732-4629-4350-86ae-b3ea662541a8
