...
Newly parked 2026-08-01: [notes-plumbing-removal](docs/plans/future/notes-plumbing-removal/plan.md) — mid-run notes were unwired from the planner in `cba8004e`, but the empty pipe they travelled through is still in the code. Removing it is a lane clash away, not a decision: chat `c91a58a9` holds all three files. Nothing edited; pick it up when that lane clears.
