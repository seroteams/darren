...
- **Phase 4 🔨 — Clear the QA pile (started 2026-07-01, your pick over Phase 2).** Walk each built-but-un-QA'd
  ...
  ([009 PLAN → Phase 4 QA pile tracker](docs/todo/009-ready-to-share/PLAN.md)). **5 ticked so far
  (2026-07-01):** repo-tidy P1 🟢 · frontend-admin-split P1 🟢 · tracker-consolidation P1 🟢 · member-nav P1 🟢
  (fix `fc77b8ba`) · stage-data-tabs 🟢 (walked live; 1 approved paid focus-points stage, a few cents). Now
  walking: sent-preview (free — shows the same Sent tab as an about-to-send preview). Remaining: repo-tidy
