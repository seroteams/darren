...
- **Phase 4 🔨 — Clear the QA pile (started 2026-07-01, your pick over Phase 2).** Walk each built-but-un-QA'd
  ...
  ([009 PLAN → Phase 4 QA pile tracker](docs/todo/009-ready-to-share/PLAN.md)). **6 ticked so far
  (2026-07-01):** repo-tidy P1 🟢 · frontend-admin-split P1 🟢 · tracker-consolidation P1 🟢 · member-nav P1 🟢
  (fix `fc77b8ba`) · stage-data-tabs 🟢 · sent-preview 🟢 (both walked live; ~2 stages of approved paid spend
  total, well under one full ~$0.35 run). **Remaining 3:** repo-tidy P2 (invisible refactor) ·
  todo-board-rebuild P3 (⚠️ UI button missing) · briefing-grounding-fixes P1 (⚠️ uncommitted).
