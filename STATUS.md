...
## ▶ Your move
1. **Walk the live first-run** — you said go live on 2026-07-26 and everything shipped (build `1db2d5c`). The one thing local could never prove: register a brand-new account on sero.team and check the brief-first welcome behaves. (The quiet rail is gone as of 2026-07-28 — see empty-states below — so live still has it until the next push.)
...
| Build | State |
|---|---|
| [empty-states](docs/plans/doing/empty-states/plan.md) | P1 ✅ green-lit 2026-07-28 — the customer rail stops hiding a new manager's rows (you hit this: a fresh account showed only What is Sero? / Send feedback). P2 🔨 building now — Team, Past 1:1s and Members get empty states that say what will appear there. [Board](https://claude.ai/code/artifact/9bc58e32-53e9-48b8-a17e-f3accbd7951b) · [mockup](https://claude.ai/code/artifact/096c0197-52f8-447a-a705-417a72cd9404). |
