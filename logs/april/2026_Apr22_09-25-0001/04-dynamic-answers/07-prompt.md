...
```json
{
  ...
  "name": "What specific actions do you think we should prioritize as a team after the refactor?",
  "description": "Aims to elicit more detailed thoughts on team priorities.",
  "purpose": "topic",
  "axis_effects": {
    "clarity": 3
  },
  "source": "swap_for:q_blockers_check_in"
}
```
...
```json
{
  "alias": "q_growth_opportunities",
  "label": "Growth opportunities",
  "name": "What skills or areas do you feel you want to grow in right now?",
  "description": "Encourages reflection on personal growth and development aspirations.",
  "purpose": "topic",
  "axis_effects": {
    "growth": 3
  },
