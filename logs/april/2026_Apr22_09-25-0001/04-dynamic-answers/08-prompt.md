...
```json
{
  ...
  "label": "Team feedback mechanisms",
  "name": "How do you think we can improve our weekly retrospectives?",
  "description": "Aims to gather thoughts on enhancing team feedback processes.",
  "purpose": "topic",
  "axis_effects": {
    "engagement": 1
  },
  "source": "swap_for:q_growth_opportunities"
}
```
...
```
more collab from the team about where things didn't go so well
```
...
```json
{
  "alias": "q_wellbeing_reflection",
  "label": "Wellbeing reflection",
  "name": "Do you feel the pace of work is sustainable for you after this recent project?",
  "description": "Tests whether the work rhythm is manageable and if there's a risk of burnout.",
  "purpose": "wellbeing",
  "axis_effects": {
    "wellbeing": 3
  },
