...
```json
{
  ...
  "name": "What aspects of the payments refactor do you think the team should celebrate the most?",
  "description": "Seeks to surface the specific achievements and recognition felt by the team after the refactor.",
  "purpose": "topic",
  "axis_effects": {
    "engagement": 3,
    "clarity": 1
...
```
probably that it works end to end and test cases are green
```
...
```json
{
  ...
  "name": "How are you feeling in terms of energy and motivation after the launch?",
  "description": "Aims to gauge Darren's wellbeing and motivation following the recent project delivery.",
  "purpose": "wellbeing",
  "axis_effects": {
    "wellbeing": 3
  },
