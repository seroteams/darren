...
[
  {
    ...
    "reason": "Just shipped the payments refactor. Worth acknowledging their contribution and impact on the team.",
    "known": true
  },
  {
    "id": "energy",
    ...
    "category": "wellbeing",
    "label": "Assessing motivation and engagement",
    "reason": "Looks a bit flat this week. Could be a temporary dip or something more — worth exploring.",
    "known": true
  },
  {
    "id": "growth",
    ...
    "reason": "Mentioned wanting to do more mentoring. Could be a chance to discuss how to facilitate that.",
    "known": true
  },
  {
    "id": "priorities",
    ...
    "reason": "Next quarter they'll likely be pulled into the billing rewrite. Worth clarifying expectations and alignment.",
    "known": true
  },
  {
    "id": "blockers",
    ...
    "category": "topic",
    "label": "Any current blockers or concerns?",
    "reason": "No specific signal — standard check-in topic. Important to ensure nothing is hindering their work.",
    "known": true
  }
]
```
...
[
  ...
  {
    "alias": "q_refactor_aftermath",
    "label": "Refactor aftermath",
    "name": "How did the payments refactor land for you after it shipped?",
    "description": "Surfaces whether the recent win actually felt rewarding or just like another delivery.",
    "purpose": "topic",
    "axis_effects": {
      "wellbeing": 1,
      "engagement": 1
  ...
  {
    "alias": "q_recognition_fit",
    "label": "Recognition fit",
    "name": "What part of the team's reaction felt most real to you?",
    "description": "Checks whether recognition matched their own sense of contribution.",
    "purpose": "topic",
    "axis_effects": {
      "engagement": 1,
      "wellbeing": 1
  ...
  {
    "alias": "q_quiet_signals",
    "label": "Quiet signals",
    "name": "I've noticed you've been quieter in standup this week — what's going on underneath that?",
    "description": "Gently probes the reason behind the recent drop in visible energy.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3,
      "engagement": 1
  ...
  {
    "alias": "q_sustainable_pace",
    "label": "Sustainable pace",
    "name": "What would make this week feel sustainable for you?",
    "description": "Looks for concrete conditions that would support recovery and steady output.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3,
      "clarity": 1
  ...
  {
    "alias": "q_mentoring_shape",
    "label": "Mentoring shape",
    "name": "What kind of mentoring would actually fit into your week?",
    "description": "Makes the mentoring interest concrete by surfacing real time and context constraints.",
    "purpose": "topic",
    "axis_effects": {
      "growth": 3,
      "clarity": 1
  ...
  {
    "alias": "q_mentoring_tradeoff",
    "label": "Mentoring tradeoff",
    "name": "What would you need to drop to make room for mentoring?",
    "description": "Forces a trade-off between development work and current responsibilities.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3,
      "clarity": 1
  ...
  {
    "alias": "q_rewrite_role",
    "label": "Rewrite role",
    "name": "What role would make sense for you in the billing rewrite?",
    "description": "Clarifies how they might best fit into the upcoming rewrite without assuming enthusiasm or resistance.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 3,
      "growth": 1
  ...
  {
    "alias": "q_rewrite_risk",
    "label": "Rewrite risk",
    "name": "Where do you expect the billing rewrite to get difficult?",
    "description": "Surfaces anticipated technical or coordination risks before the work starts.",
    "purpose": "competency",
    "axis_effects": {
      "clarity": 1,
      "growth": 1
  ...
  {
    "alias": "q_need_to_know",
    "label": "Need to know",
    "name": "What do you need to know before the billing rewrite starts?",
    "description": "Checks for missing context, expectations, or decisions that would affect readiness.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 3
    }
  ...
  {
    "alias": "q_blocker_ownership",
    "label": "Blocker ownership",
    "name": "What are you waiting on that could quietly stall you?",
    "description": "Identifies dependencies that are not yet being escalated or managed.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 3,
      "engagement": 1
  ...
  {
    "alias": "q_stretch_edge",
    "label": "Stretch edge",
    "name": "What part of your work right now feels most like a stretch?",
    "description": "Finds where they are learning, overextended, or under-challenged in a concrete way.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3,
      "wellbeing": 1
  ...
  },
  {
    "alias": "q_next_skill",
    "label": "Next skill",
    "name": "What skill do you want to sharpen over the next quarter?",
    "description": "Opens a practical growth conversation tied to the upcoming work cycle.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3,
      "engagement": 1
