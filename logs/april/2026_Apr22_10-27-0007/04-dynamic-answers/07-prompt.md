...
[
  ...
  },
  {
    ...
    "name": "What would a more challenging or stretching task look like right now?",
...
```json
{
  ...
  "name": "What's blocked the mentoring from happening — your time, opportunity, or something else?",
  "description": "Explores the reasons behind the stalled mentoring interest.",
  "purpose": "topic",
  "axis_effects": {
    "growth": 3
  },
...
[
  ...
  },
  {
    ...
    "name": "Where's your energy at after the payments push, and what's helping or hindering it?",
    "description": "Assesses current energy levels post-project and identifies factors affecting them.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3
    }
