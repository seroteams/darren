...
```
She likes to pick her nose a lot, but she loves going to school
```
...
[
  {
    ...
    "category": "wellbeing",
    "label": "Balancing school and personal interests",
    "reason": "Notes mention her love for school. Could be worth exploring how she balances school with her personal interests.",
    "known": true
  },
  {
    "id": "team_connection",
    ...
    "category": "wellbeing",
    "label": "Connection with peers at school",
    "reason": "No specific signal — standard check-in topic. Understanding her social dynamics could provide insight into her overall wellbeing.",
    "known": true
  },
  {
    "id": "priorities",
    ...
    "category": "topic",
    "label": "Current focus areas in school",
    "reason": "No specific signal — typical for this role/meeting. It's important to align on what she's prioritizing academically.",
    "known": true
  },
  {
    "id": "growth",
    ...
    "category": "topic",
    "label": "Skills she's excited to develop",
    "reason": "No specific signal — common for seniors; worth discussing what growth areas she's interested in.",
    "known": true
  },
  {
    "id": "manager_support",
    ...
    "reason": "No specific signal — standard check-in hygiene. It’s good to understand how you can better support her at this stage.",
    "known": true
  }
]
```
...
[
  {
    ...
    "answer": "Getting to school took a long time, the BTS saw slow and very busy.",
    "skipped": false
  },
  {
    "question": "How is school fitting around your other interests right now?",
    "alias": "q_school_load_balance",
    "answer": "fine, it's a few hours and there is time after school to do stuff. and i don't have much home work. i'd like more ECA's - i only do mondays",
    "skipped": false
  },
  {
    "question": "What part of school has been giving you the most energy lately?",
    "alias": "q_school_energy",
    "answer": "playground and football pitch and playing basket ball",
    "skipped": false
  },
  {
    "question": "What are you actually focused on this week, and why those things?",
    "alias": "q_intro_biweekly_priorities",
    "answer": "training for football and basketball, but i hurt my knee",
    "skipped": false
  },
  {
    "question": "What would make these check-ins more useful for you?",
    "alias": "q_support_from_manager",
    "answer": "if they were more often, sometimes i feel like i've been forgotten",
    "skipped": false
  },
  {
    "question": "Who at school do you feel most connected to lately?",
    "alias": "q_peer_connection",
    "answer": "my teacher, Mr Jobe but also my friends who i play with at lunch time. But Josy hit my arm the other day and it hurt",
    "skipped": false
  },
  {
    "question": "Where at school are you getting pushed in a good way?",
    "alias": "q_learning_stretch",
    "answer": "Thai lessons and music. But sometimes the teachers don't listen to me",
    "skipped": false
  },
  {
    "question": "What would feel like a real step up for you over the next few weeks?",
    "alias": "q_next_stretch_2",
    "answer": "if i had no school and i could just stay in the bath for the rest of my life and play with bubbles",
    "skipped": false
  }
]
```
...
```json
{
  "wellbeing": {
    ...
    "history": [
      {
        "q": "q_school_load_balance",
        "delta": 1,
        "answer_excerpt": "fine, it's a few hours and there is time after school to do stuff. and i don't have much home work. i'd like more ECA's - i only do mondays"
      },
      {
        "q": "q_school_energy",
        "delta": 1,
        "answer_excerpt": "playground and football pitch and playing basket ball"
      },
      {
        "q": "q_support_from_manager",
        "delta": 1,
        "answer_excerpt": "if they were more often, sometimes i feel like i've been forgotten"
      },
      {
        "q": "q_peer_connection",
        "delta": -1,
        "answer_excerpt": "my teacher, Mr Jobe but also my friends who i play with at lunch time. But Josy hit my arm the other day and it hurt"
      }
    ]
  },
  "engagement": {
    ...
    "history": [
      {
        ...
        "delta": 1,
        "answer_excerpt": "Getting to school took a long time, the BTS saw slow and very busy."
      },
      {
        "q": "q_school_energy",
        "delta": 3,
      ...
      },
      {
        "q": "q_next_stretch_2",
        "delta": -1,
        "answer_excerpt": "if i had no school and i could just stay in the bath for the rest of my life and play with bubbles"
      }
    ]
  },
  "clarity": {
    ...
    "history": [
      ...
      },
      {
        ...
        "delta": 1,
        "answer_excerpt": "training for football and basketball, but i hurt my knee"
      },
      {
        "q": "q_support_from_manager",
        "delta": 1,
      ...
      {
        "q": "q_learning_stretch",
        "delta": 1,
        "answer_excerpt": "Thai lessons and music. But sometimes the teachers don't listen to me"
      }
    ]
  },
  "growth": {
