...
- Is final turn: false
- Current stage hint (last question's stage): `landing`
...
[
  ...
  {
    "alias": "q_voice_leverage_2",
    "name": "In those leadership meetings, what feels unclear about where your voice has leverage?",
  ...
  {
    "alias": "q_less_grounded_2",
    "name": "When you say 'less grounded' — what feels less steady day to day?",
...
```json
{
  ...
  "label": "Less grounded",
  "name": "When you say 'less grounded' — what feels less steady day to day?",
  "description": "Drills into her 'less grounded' phrasing to surface what has actually shifted underneath.",
  "purpose": "wellbeing",
  "stage": "landing",
  "axis_effects": {
    "wellbeing": 1,
...
```
I have been protecting my team from noise, which means I am carrying more ambiguity myself.
```
