...
[
  ...
  },
  {
    ...
    "name": "When you say 'how decisions are really made here,' what feels most unclear?",
  ...
  },
  {
    ...
    "name": "Which tradeoffs feel hardest to read without the backstory?",
  ...
  },
  {
    ...
    "name": "What would make the escalation line clearer in practice for you?",
...
```json
{
  ...
  "name": "What would make the escalation line clearer in practice for you?",
  "description": "Surfaces the concrete cues or examples Riley needs to know when to escalate versus batch questions.",
  "purpose": "topic",
  "stage": "orientation",
  "axis_effects": {
    "clarity": 3,
