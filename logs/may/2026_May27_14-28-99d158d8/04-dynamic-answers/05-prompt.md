...
[
  ...
  {
    "alias": "q_coasting_this_week_2",
    "name": "You said you're 'coasting a bit this week' — what's driving that?",
    "answer": "Cleanup and docs for payments, reviewing PRs for the new team members. Not much stretching me right now.",
    "skipped": false
  },
  {
    "alias": "q_stretch_gap_2",
    "name": "You said 'not much stretching me right now' — what kind of work would feel stretching in a good way?",
  ...
  {
    "alias": "q_mentoring_stalled",
    "name": "You said 'more mentoring' — what's kept that from happening so far?",
...
{
  "alias": "q_mentoring_stalled",
  "label": "Mentoring stalled",
  "name": "You said 'more mentoring' — what's kept that from happening so far?",
  "description": "Drills into the stalled mentoring thread to surface the real blocker.",
  "purpose": "topic",
  "stage": "momentum",
  "axis_effects": {
    "growth": 3
...
```
Honestly — the billing rewrite. I've heard whispers but nobody's talked to me about it directly. That's a bit weird.
```
