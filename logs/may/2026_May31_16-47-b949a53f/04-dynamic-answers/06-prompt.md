...
- Is final turn: false
- Current stage hint (last question's stage): `evidence`
...
```json
{
  ...
  "name": "Sharper feedback earlier — what stops you doing that in the moment?",
  "description": "Drills into the specific behaviour he named before progressing, to surface the live blocker.",
  "purpose": "competency",
  "stage": "evidence",
  "axis_effects": {
    "engagement": 3,
...
```
I have not built enough trust with adjacent teams yet.
```
