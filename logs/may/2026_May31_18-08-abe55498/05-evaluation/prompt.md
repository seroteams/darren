...
[
  {
    ...
    "type": "Impact",
    "category": "competency",
    "label": "Principal-level impact and leverage on this team.",
    "reason": "Whether they can point to the Principal-sized outcomes they’re driving right now, not just steady delivery—could be that the work is happening but the impact isn’t yet visible or communicated.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "type": "Role clarity",
    "category": "topic",
    "label": "What Principal scope means in this team.",
    "reason": "Whether they’ve internalized the current team’s expectations for Principal scope, or if they’re still operating on old assumptions from the prior team—worth clarifying explicitly so feedback can land precisely.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Cross-team trust and hard-call judgment.",
    "reason": "Whether their cross-team relationships are building in both directions and whether they’re making the tradeoff calls early enough, or staying in safe execution mode and waiting for others.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "type": "Communication",
    "category": "competency",
    "label": "Early expectation alignment in how they engage.",
    "reason": "What they’re doing in this meeting cycle to align expectations early—Principal work often fails quietly when context and assumptions aren’t surfaced early enough for stakeholders to steer.",
...
[
  ...
  {
    "question": "When you say 'highest-leverage work,' what work are you thinking of specifically?",
    "alias": "q_highest_leverage_work_5",
    "answer": "I can describe Principal impact in general, but this team's bar still feels fuzzy.",
    "skipped": false
  },
  {
    "question": "This team's bar feels fuzzy — where does that show up most in your work?",
    "alias": "q_team_s_bar_fuzzy",
  ...
  {
    "question": "You said 'being safe' — what does that look like in practice?",
    "alias": "q_safe_execution",
  ...
  },
  {
    ...
    "alias": "q_sharper_feedback_5",
    "answer": "I have not built enough trust with adjacent teams yet.",
    "skipped": false
  },
  {
    "question": "Adjacent teams — where is the trust not there yet?",
    "alias": "q_adjacent_team_trust_2",
    "answer": "The gap is less technical and more around visible ownership.",
    "skipped": false
  },
  {
    "question": "Given this, where do you want to change your early alignment first?",
    "alias": "q_commitment_closer_2",
    "answer": "I need explicit expectations for the next cycle so I can calibrate fast.",
    "skipped": false
  },
  {
    "question": "What will you do differently on early alignment before we next meet?",
    "alias": "q_commitment_closer",
