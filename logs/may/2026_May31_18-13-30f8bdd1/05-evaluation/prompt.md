...
[
  {
    ...
    "category": "wellbeing",
    "label": "Late nights vs sustainable pace now",
    "reason": "Notes mention several weeks of late nights and downplaying concern. Could be a temporary sprint push, or a longer-term capacity mismatch—worth clarifying what’s driving the load this cycle now that pressure is over.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "reason": "Whether her focus has shifted from catching up to the next set of outcomes. In a bi-weekly check-in, you want to confirm what she’s saying yes and no to right now so execution stays aligned to the team’s bets.",
  ...
  },
  {
    ...
    "category": "topic",
    "label": "Recognition and visibility that keeps her engaged",
    "reason": "Notes flag strong execution without recognition can quietly drain engagement. Could be she needs more public credit, clearer ownership signals, or better stakeholder visibility—worth clarifying what “seen” means to her.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "Where influence is blocked or unclear",
    "reason": "Where she feels blocked in visibility and influence is likely tied to dependencies, decision rights, or missing context. Clarifying the specific bottleneck helps you unblock her without guessing.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "What support she wants from you",
    "reason": "Whether she wants more air cover, faster decisions, or more coaching—senior engineers often stop asking when they assume you’re busy. This is the most direct way to translate the conversation into concrete help for the next two weeks.",
    "source": "best_practice",
    "known": true
  }
]
...
[
  ...
  {
    "question": "push worked, want — can you say more about what that means for you right now?",
    "alias": "q_thread_follow_14",
    "answer": "I am less overloaded now, but my calendar is still fragmented.",
    "skipped": false
  },
  {
    "question": "Calendar is still fragmented — what's chopping it up most?",
    "alias": "q_fragmented_calendar_4",
    "answer": "A lot of energy went into firefighting and context switching.",
    "skipped": false
  },
  {
    "question": "How's the last two weeks actually felt — energy-wise?",
    "alias": "q_intro_biweekly_pace",
    "answer": "I can ship quickly, but I do not always feel the impact is visible.",
    "skipped": false
  },
  {
    "question": "Impact not visible — where is that breaking down most for you?",
    "alias": "q_visible_impact_6",
    "answer": "Feedback on communication landed, and I am still processing it.",
    "skipped": false
  },
  {
    "question": "Communication feedback — what part of it are you still working through?",
    "alias": "q_communication_feedback_4",
    "answer": "I want more room to lead cross-functional discussions earlier.",
    "skipped": false
  },
  {
    "question": "What are you actually focused on this week, and why those things?",
    "alias": "q_intro_biweekly_priorities",
    "answer": "The next two weeks should focus on stabilizing and reducing reactive work.",
    "skipped": false
  },
  {
    "question": "Where do you want more visible ownership on the frontend work?",
    "alias": "q_visible_ownership",
    "answer": "Clear priority tradeoffs from leadership would help a lot.",
    "skipped": false
  },
  {
    "question": "Given what we've covered, what would make the next two weeks steadier for you?",
    "alias": "q_next_two_weeks_20",
    "answer": "I want to pick one priority tradeoff to resolve with leadership before the next two weeks get noisier.",
    "skipped": false
  }
]
```
    ...
    "history": [
      {
        ...
        "delta": -1,
        "answer_excerpt": "I can ship quickly, but I do not always feel the impact is visible."
      },
      {
        "q": "q_visible_impact_6",
        "delta": -1,
        "answer_excerpt": "Feedback on communication landed, and I am still processing it."
      },
      {
        "q": "q_communication_feedback_4",
        "delta": -1,
        "answer_excerpt": "I want more room to lead cross-functional discussions earlier."
      },
      {
        "q": "q_next_two_weeks_20",
        "delta": 1,
        "answer_excerpt": "I want to pick one priority tradeoff to resolve with leadership before the next two weeks get noisier."
      }
    ]
  },
  "engagement": {
    ...
    "history": [
      {
        ...
        "delta": -1,
        "answer_excerpt": "The push worked, but I do not want that pace to become normal."
      },
      {
        "q": "q_thread_follow_14",
        "delta": -1,
        "answer_excerpt": "I am less overloaded now, but my calendar is still fragmented."
      },
      {
        "q": "q_intro_biweekly_pace",
        "delta": -1,
      ...
      },
      {
        ...
        "delta": 1,
        "answer_excerpt": "The next two weeks should focus on stabilizing and reducing reactive work."
      },
      {
        "q": "q_visible_ownership",
        "delta": -3,
        "answer_excerpt": "Clear priority tradeoffs from leadership would help a lot."
      }
    ]
  },
  "clarity": {
    ...
    "history": [
      ...
      {
        "q": "q_fragmented_calendar_4",
        "delta": -1,
        "answer_excerpt": "A lot of energy went into firefighting and context switching."
      },
      {
        "q": "q_communication_feedback_4",
        "delta": -1,
