...
- Is final turn: false
- Current stage hint (last question's stage): `pulse`
...
[
  ...
  },
  {
    ...
    "name": "Calendar is still fragmented — what's chopping it up most?",
  ...
  },
  {
    ...
    "name": "Impact not visible — where is that breaking down most for you?",
...
```json
{
  ...
  "name": "Impact not visible — where is that breaking down most for you?",
  "description": "Drills into the visibility gap she just named so you can locate the specific bottleneck.",
  "purpose": "topic",
  "stage": "pulse",
  "axis_effects": {
    "engagement": 1,
