...
```
not great ive been distracted with so many things
```
...
[
  ...
  },
  {
    ...
    "name": "How sustainable does your current workload feel over the long term?",
    "description": "Explores whether Carl's workload is manageable and sustainable.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3
    }
  },
  {
    ...
    "label": "Focus area priorities",
    "name": "What are your top three priorities for the next month?",
    "description": "Aims to clarify Carl's immediate priorities and ensure alignment.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 3
    }
  },
  {
    ...
    "name": "How do you decide which tasks to delegate to your team?",
    "description": "Investigates Carl's approach to delegation and its effectiveness.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3
    }
  ...
  {
    "alias": "q_effective_task_selection",
    "label": "Effective task selection",
    "name": "What criteria do you use to choose which tasks to focus on?",
    "description": "Probes Carl's judgment in selecting tasks that align with team goals.",
    "purpose": "competency",
    "axis_effects": {
      "clarity": 3
    }
  ...
  {
    "alias": "q_impact_visibility",
    "label": "Impact visibility",
    "name": "How do you track and measure the impact of your work?",
    "description": "Examines Carl's understanding of the impact his work is having.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3
    }
  ...
  {
    "alias": "q_energy_drivers_2",
    "label": "Energy drivers",
    "name": "What aspects of your work currently energize you the most?",
    "description": "Identifies what drives Carl's motivation and energy at work.",
    "purpose": "wellbeing",
    "axis_effects": {
      "engagement": 3
    }
  },
  {
    ...
    "name": "How do you feel your workload is affecting your ability to innovate and propose new ideas?",
    "description": "Explores the impact of workload on Carl's creativity and initiative.",
    "purpose": "wellbeing",
    "axis_effects": {
      "engagement": 3
    }
  ...
  {
    "alias": "q_improvement_opportunities",
    "label": "Improvement opportunities",
    "name": "Where do you see opportunities for improving your impact on the team?",
    "description": "Encourages Carl to identify areas for development in his role.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3
    }
  ...
  {
    "alias": "q_task_alignment",
    "label": "Task alignment",
    "name": "How do you ensure that your daily tasks align with our team's goals?",
    "description": "Assesses how Carl aligns his work with broader team objectives.",
    "purpose": "competency",
    "axis_effects": {
      "clarity": 3
    }
  ...
  {
    "alias": "q_empowerment_challenges",
    "label": "Empowerment challenges",
    "name": "What challenges do you face when trying to empower your team to take on more?",
    "description": "Discusses challenges in delegation and team empowerment.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3
    }
  ...
  {
    "alias": "q_energy_sustainability",
    "label": "Energy sustainability",
    "name": "What changes would make your workload feel more sustainable?",
    "description": "Explores potential adjustments to improve Carl's workload sustainability.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3
    }
