...
[
  ...
  {
    "alias": "q_strategic_bet_gap",
    "name": "What stands between you and owning a strategic bet today?",
...
{
  "alias": "q_strategic_bet_gap",
  "label": "Strategic bet gap",
  "name": "What stands between you and owning a strategic bet today?",
  "description": "Surfaces the main gap between his current role and the strategic ownership he wants.",
  "purpose": "topic",
  "stage": "gap",
  "axis_effects": {
    "growth": 3,
...
```
I should delegate more of the hands-on work to create room for that.
```
