...
[
  ...
  {
    "question": "You mentioned coasting a bit this week — what's contributing to that feeling?",
  ...
  {
    "question": "Did the recognition for the refactor feel right for you?",
    "alias": "q_recognition_landing_3",
    "answer": "Nothing big. A lot of context-switching on reviews — probably fine, but it adds up.",
    "skipped": false
  },
  {
    "question": "How is the context-switching on reviews affecting your work and focus?",
  ...
  {
    "question": "You've heard whispers about the billing rewrite — what's missing in terms of clarity or communication for you?",
  ...
  {
    "question": "You mentioned owning the migration plan for payments — what specifically made it a success for you?",
  ...
  {
    "question": "When you say 'growth-wise I'm flat', what's missing — challenge, feedback, or something else?",
