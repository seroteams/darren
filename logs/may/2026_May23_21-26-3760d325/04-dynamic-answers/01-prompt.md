...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
  ...
  "Generic 'how do you feel about X' instead of locating the friction."
   ...
   The last question's stage was: `friction`.
   ...
   **Consecutive drill count at current stage:** `0` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
   ...
   - **Final turn enforcement.** When `is_final_turn` is `true` or `remaining_budget = 1`, the closer wins unless crisis override or broken-session applies.
     - If `q_next_steps_priority_3` is not `"(none)"`, the first item in `new_queue` MUST have `ref_alias === "q_next_steps_priority_3"`.
     - Copy that item verbatim from the remaining queue.
     - Do not modify it.
     - Do not add a thread-follow question.
     - Do not open a new concern.
     - If `q_next_steps_priority_3` is `"(none)"`, generate one commitment-stage question asking for the next concrete move.
...
[
  {
    ...
    "reason": "Just shipped the payments refactor — it's a big win, and the team noticed. Worth making sure the recognition has landed well, especially if they're looking quieter this week.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "wellbeing",
    "label": "Energy levels and engagement this week.",
    "reason": "Notes mention Priya looks a bit flat and quieter than usual in standup. Could be a temporary dip, post-shipment lull, or something else — worth checking in.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "Interest in mentoring and potential next steps.",
    "reason": "Mentioned they'd like to do more mentoring. Whether this is a new interest or a revived one, it's worth exploring how they envision this fitting into their role.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "reason": "Whether they know about the upcoming billing rewrite and how they're preparing for it. Standard bi-weekly anchor to ensure they're aligned with upcoming priorities.",
...
- Is final turn: false
- Reserved closer alias: q_next_steps_priority_3
- Arc progress (turns spent per stage): see `{
  "pulse": 0,
  "friction": 1,
  "momentum": 0,
  "lift": 0
}` above in `<planning_rules>` rule 7
...
[
  ...
  {
    "alias": "q_current_focus_5",
    "label": "Current focus",
    "name": "What's been most on your mind at work lately?",
    "description": "Allows Priya to share her current focus or concerns.",
    "purpose": "wellbeing",
    "stage": "pulse",
    "axis_effects": {
      "wellbeing": 1
  ...
  {
    "alias": "q_post_refactor_energy_2",
    "label": "Post-refactor energy",
    "name": "How's your energy been since the payments refactor shipped?",
    "description": "Checks if there's a dip in energy post-refactor.",
    "purpose": "wellbeing",
    "stage": "pulse",
    "axis_effects": {
      "wellbeing": 3
  ...
  {
    "alias": "q_recognition_landing_3",
    "label": "Recognition landing",
    "name": "Did the recognition for the refactor feel right for you?",
    "description": "Explores if the recognition for the refactor was satisfying.",
    "purpose": "topic",
    "stage": "friction",
    "axis_effects": {
      "engagement": 1
  ...
  {
    "alias": "q_mentoring_vision_7",
    "label": "Mentoring vision",
    "name": "What would you like mentoring to look like in your role?",
    "description": "Explores Priya's vision for mentoring within her current role.",
    "purpose": "topic",
    "stage": "momentum",
    "axis_effects": {
      "growth": 3
  ...
  {
    "alias": "q_upcoming_shifts",
    "label": "Upcoming shifts",
    "name": "How do you feel about the projects coming up next quarter?",
    "description": "Gauges Priya's feelings about upcoming project changes.",
    "purpose": "topic",
    "stage": "momentum",
    "axis_effects": {
      "clarity": 1
  ...
  {
    "alias": "q_mentoring_space_2",
    "label": "Mentoring space",
    "name": "What would you need to drop to make space for mentoring?",
    "description": "Encourages Priya to think about trade-offs for mentoring.",
    "purpose": "topic",
    "stage": "friction",
    "axis_effects": {
      "clarity": 1
  ...
  {
    "alias": "q_post_launch_reflection_2",
    "label": "Post-launch reflection",
    "name": "Looking back, what made the payments refactor work well?",
    "description": "Encourages reflection on successful elements of the refactor.",
    "purpose": "topic",
    "stage": "momentum",
    "axis_effects": {
      "growth": 1
  ...
  {
    "alias": "q_energy_and_engagement",
    "label": "Energy and engagement",
    "name": "What's driving your engagement or lack of it this week?",
    "description": "Probes underlying factors affecting current engagement.",
    "purpose": "wellbeing",
    "stage": "friction",
    "axis_effects": {
      "engagement": 3
  ...
  {
    "alias": "q_next_steps_priority_3",
    "label": "Next steps priority",
    "name": "Given what we've talked about, what's your priority for the next two weeks?",
    "description": "Encourages Priya to clarify her immediate priorities.",
    "purpose": "topic",
    "stage": "lift",
    "axis_effects": {
      "clarity": 1
