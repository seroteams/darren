...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `3` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
...
- Consecutive drills at current stage: 3
...
{
  "alias": "q_billing_rewrite_clarity_4",
  "label": "Billing rewrite clarity",
  "name": "You've heard whispers about the billing rewrite — what's missing in terms of clarity or communication for you?",
  "description": "Identifies gaps in communication and clarity about the billing rewrite.",
  "purpose": "topic",
  "stage": "friction",
  "axis_effects": {
    "clarity": 3
...
```
Payments was real — I owned the migration plan and made the call on the dual-write window. I'm proud of how that went.
```
