...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `2` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
...
{
  "alias": "q_mentoring_block_5",
  "label": "Mentoring block",
  "name": "What's blocked the mentoring from happening — your time, opportunity, or something else?",
  "description": "Identifies specific barriers preventing mentoring from progressing.",
  "purpose": "topic",
  "stage": "friction",
  "axis_effects": {
    "growth": 3
