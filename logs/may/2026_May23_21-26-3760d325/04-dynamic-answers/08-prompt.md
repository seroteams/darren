...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `5` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
...
- Consecutive drills at current stage: 5
...
[
  ...
  {
    "alias": "q_growth_stagnation_2",
    "name": "When you say 'growth-wise I'm flat', what's missing — challenge, feedback, or something else?",
...
{
  "alias": "q_growth_stagnation_2",
  "label": "Growth stagnation",
  "name": "When you say 'growth-wise I'm flat', what's missing — challenge, feedback, or something else?",
  "description": "Clarifies the specifics of Priya's growth stagnation.",
  "purpose": "topic",
  "stage": "friction",
  "axis_effects": {
    "growth": 3
