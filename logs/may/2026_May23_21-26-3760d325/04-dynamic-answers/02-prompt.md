...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `1` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
...
{
  "alias": "q_coasting_this_week",
  "label": "Coasting this week",
  "name": "You mentioned coasting a bit this week — what's contributing to that feeling?",
  "description": "Explores underlying reasons for current coasting state.",
  "purpose": "topic",
  "stage": "friction",
  "axis_effects": {
    "engagement": 3
