...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `4` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
...
- Consecutive drills at current stage: 4
...
[
  ...
  {
    "alias": "q_coasting_this_week",
    "name": "You mentioned coasting a bit this week — what's contributing to that feeling?",
  ...
  {
    "alias": "q_context_switching_impact",
    "name": "How is the context-switching on reviews affecting your work and focus?",
    "answer": "I'd like to do more mentoring. I brought it up maybe three months ago and nothing came of it. I'm not pushing.",
    "skipped": false
  },
  {
    "alias": "q_mentoring_block_5",
    "name": "What's blocked the mentoring from happening — your time, opportunity, or something else?",
    "answer": "Honestly — the billing rewrite. I've heard whispers but nobody's talked to me about it directly. That's a bit weird.",
    "skipped": false
  },
  {
    "alias": "q_billing_rewrite_clarity_4",
    "name": "You've heard whispers about the billing rewrite — what's missing in terms of clarity or communication for you?",
  ...
  {
    "alias": "q_pride_in_payments",
    "name": "You mentioned owning the migration plan for payments — what specifically made it a success for you?",
...
{
  "alias": "q_pride_in_payments",
  "label": "Pride in payments",
  "name": "You mentioned owning the migration plan for payments — what specifically made it a success for you?",
  "description": "Drills into the success factors of the payments refactor Priya is proud of.",
  "purpose": "topic",
  "stage": "friction",
  "axis_effects": {
    "clarity": 3
...
```
Growth-wise I think I'm flat. I'm the most senior IC on the team and there's no one really pushing me.
```
