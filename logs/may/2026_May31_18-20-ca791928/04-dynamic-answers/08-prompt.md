...
- Is final turn: true
- Current stage hint (last question's stage): `investment`
...
[
  ...
  },
  {
    ...
    "name": "Cross-org decision area — which decisions do you want your name attached to?",
...
```
I want milestones that show progress before the next cycle, not only retrospective feedback.
```
