...
- Is final turn: false
- Current stage hint (last question's stage): `anchor`
...
[
  ...
  },
  {
    ...
    "name": "Political capital — where are you choosing to hold back right now?",
  ...
  },
  {
    ...
    "name": "Visible strategic influence — what would that look like when you're operating at your best?",
  ...
  },
  {
    ...
    "name": "High-ambiguity forums — what makes those rooms feel risky for you?",
...
{
  "alias": "q_high_ambiguity_forums_2",
  "label": "High-ambiguity forums",
  "name": "High-ambiguity forums — what makes those rooms feel risky for you?",
  "description": "Drills into the specific avoidance pattern to surface the real constraint behind stalled stretch.",
  "purpose": "topic",
  "stage": "anchor",
  "axis_effects": {
    "growth": 3,
...
```
I think I need to own a cross-org decision area, not just deliver strong design outcomes.
```
