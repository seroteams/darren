...
7. **Meeting arc.** The session follows a meeting-type-specific arc, not a generic early/middle/late grounding pattern. The current arc is:
   ...
   **Consecutive drill count at current stage:** `0` (planner_added turns in a row at this stage — when this reaches 2, the drill cap in `<thread_follow_rule>` blocks further drills).
   ...
   - **Final turn enforcement.** When `is_final_turn` is `true` or `remaining_budget = 1`, the closer wins unless crisis override or broken-session applies.
     - If `q_next_steps_6` is not `"(none)"`, the first item in `new_queue` MUST have `ref_alias === "q_next_steps_6"`.
     - Copy that item verbatim from the remaining queue.
     - Do not modify it.
     - Do not add a thread-follow question.
     - Do not open a new concern.
     - If `q_next_steps_6` is `"(none)"`, generate one commitment-stage question asking for the next concrete move.
...
- Is final turn: false
- Reserved closer alias: q_next_steps_6
...
[
  ...
  {
    "alias": "q_recent_weeks_overview",
    "label": "Recent weeks overview",
    "name": "How has the last couple of weeks felt from your side, Priya?",
    "description": "Open context-setting question to gauge overall sentiment.",
    "purpose": "wellbeing",
    "stage": "pulse",
    "axis_effects": {
      "wellbeing": 1
  ...
  {
    "alias": "q_energy_levels_post_launch",
    "label": "Energy levels post-launch",
    "name": "What do you think is driving your current energy levels after the payments refactor?",
    "description": "Explores underlying reasons for current energy levels and motivation.",
    "purpose": "wellbeing",
    "stage": "friction",
    "axis_effects": {
      "wellbeing": 3
  ...
  {
    "alias": "q_mentoring_interest_4",
    "label": "Mentoring interest",
    "name": "What would mentoring look like for you, and what do you need to make it happen?",
    "description": "Explores specific interest in mentoring and what it would require.",
    "purpose": "topic",
    "stage": "friction",
    "axis_effects": {
      "growth": 3
  ...
  {
    "alias": "q_current_challenges_4",
    "label": "Current challenges",
    "name": "What part of your work is currently causing the most friction or challenge?",
    "description": "Identifies specific areas of work where challenges are present.",
    "purpose": "topic",
    "stage": "friction",
    "axis_effects": {
      "clarity": 1
  ...
  {
    "alias": "q_refactor_achievement",
    "label": "Refactor achievement",
    "name": "How did the recognition for the payments refactor land with you?",
    "description": "Surfaces whether recognition was felt and appreciated.",
    "purpose": "competency",
    "stage": "momentum",
    "axis_effects": {
      "engagement": 3
  ...
  {
    "alias": "q_next_project_focus",
    "label": "Next project focus",
    "name": "What kind of project are you hoping to focus on next?",
    "description": "Probes for project preferences and aspirations.",
    "purpose": "topic",
    "stage": "momentum",
    "axis_effects": {
      "growth": 1
  ...
  {
    "alias": "q_priority_alignment_12",
    "label": "Priority alignment",
    "name": "Do you feel aligned with the team’s current priorities?",
    "description": "Checks alignment with current team priorities and any potential misalignment.",
    "purpose": "competency",
    "stage": "momentum",
    "axis_effects": {
      "clarity": 3
  ...
  {
    "alias": "q_energy_sustainability_2",
    "label": "Energy sustainability",
    "name": "Is the current workload sustainable for you?",
    "description": "Gauges whether the workload is sustainable and not leading to burnout.",
    "purpose": "wellbeing",
    "stage": "lift",
    "axis_effects": {
      "wellbeing": 3
  ...
  {
    "alias": "q_next_steps_6",
    "label": "Next steps",
    "name": "What's the first concrete thing you want to have moved by our next conversation?",
    "description": "Encourages action and sets a focus for the next period.",
    "purpose": "competency",
    "stage": "lift",
    "axis_effects": {
      "growth": 1
