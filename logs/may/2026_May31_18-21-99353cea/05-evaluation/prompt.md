...
[
  {
    ...
    "type": "Role clarity",
    "category": "topic",
    "label": "Ownership boundaries and what “good” means here.",
    "reason": "Whether he feels clear on ownership boundaries and expectations for his level, especially around what he should drive vs what he should escalate or coordinate.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "Where to ask for context before assumptions.",
    "reason": "Whether he knows the right places to get team-specific context so he doesn’t build an internal map that differs from how the team actually operates.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "reason": "Whether he understands incident expectations and who he should loop in early, so he can act correctly under pressure rather than relying on docs.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "Concrete onboarding support you can add now.",
    "reason": "What he would want more of from you during onboarding—fast feedback loops, clearer decision context, and explicit introductions—so missing context gets filled early instead of later.",
...
[
  {
    "question": "What's been most on your mind at work this week, Riley?",
    "alias": "q_week_two_pulse",
    "answer": "I am comfortable reading the services, but I am less sure how decisions are really made here.",
    "skipped": false
  },
  {
    "question": "When you say 'how decisions are really made here,' what feels least clear?",
    "alias": "q_decision_making_gap",
    "answer": "I can trace most request paths now, though I still miss historical context behind certain tradeoffs.",
    "skipped": false
  },
  {
    "question": "Which tradeoffs feel hardest to understand the history behind?",
    "alias": "q_tradeoff_context_3",
    "answer": "I have not been fully clear on who is on point for each domain when priorities conflict.",
    "skipped": false
  },
  {
    "question": "What context are you still missing before you make bigger calls, Riley?",
    "alias": "q_context_gaps",
    "answer": "I am trying not to interrupt people, so sometimes I keep questions in a notes doc instead of asking.",
    "skipped": false
  },
  {
    "question": "That notes doc habit — what makes it hard to ask in the moment?",
    "alias": "q_notes_doc_habit_2",
  ...
  },
  {
    ...
    "alias": "q_escalate_vs_batch",
    "answer": "The runbook helped, but some practical handoff details only show up during live incidents.",
    "skipped": false
  },
  {
    "question": "Who have you had the most useful direct contact with so far, Riley?",
    "alias": "q_team_contact_2",
    "answer": "A short weekly architecture review with someone senior would help me calibrate faster.",
    "skipped": false
  },
  {
    "question": "What would be most useful from me over the next couple of weeks, Riley?",
    "alias": "q_support_needed_19",
    "answer": "If I know exactly what ownership I should take this month, I can contribute with more confidence.",
    "skipped": false
  },
  {
    "question": "Given what we've covered, what should we tighten up before our next check-in?",
    "alias": "q_next_step_landing",
