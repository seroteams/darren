...
[
  {
    ...
    "reason": "Whether the Principal scope is translating into visible outcomes on this team, or if delivery is steady while impact is still not landing publicly.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "type": "Role clarity",
    "category": "topic",
    "label": "Early expectation alignment for Principal scope",
    "reason": "Whether he understands what “good” looks like at Principal on this team right now, especially given prior feedback about needing earlier expectation alignment.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Cross-team trust and hard calls developing",
    "reason": "What you need to see at Principal level is growing judgment in ambiguous situations and stronger relationships beyond the immediate team.",
  ...
  },
  {
    ...
    "type": "Judgment",
    "category": "competency",
    "label": "Judgment calls on tradeoffs vs safe execution",
    "reason": "Whether he’s making and escalating the right tradeoffs for Principal scope, or staying in safe execution mode by asking fewer questions and waiting for direction.",
    "source": "signal",
    "known": true
  }
]
...
[
  ...
  {
    "question": "When you say 'highest-leverage work,' what work are you pointing to specifically?",
    "alias": "q_highest_leverage_work_6",
    "answer": "I can describe Principal impact in general, but this team's bar still feels fuzzy.",
    "skipped": false
  },
  {
    "question": "This team's bar feels fuzzy — where does that show up most concretely?",
    "alias": "q_team_bar_fuzzy_4",
  ...
  {
    "question": "have made calls — can you say more about what that means for you right now?",
    "alias": "q_thread_follow_23",
    "answer": "I probably should ask for sharper feedback earlier than I do.",
    "skipped": false
  },
  {
    "question": "Sharper feedback earlier — what has stopped you doing that sooner?",
    "alias": "q_sharper_feedback_6",
  ...
  {
    "question": "What keeps you from asking more questions earlier?",
    "alias": "q_questioning_pattern",
    "answer": "I need explicit expectations for the next cycle so I can calibrate fast.",
    "skipped": false
  },
  {
    "question": "What would help you spot expectation drift earlier next time?",
    "alias": "q_earlier_signals",
