...
- Total turns: 9
- Reserved closer alias: q_first_move_6
...
[
  {
    ...
    "type": "Role clarity",
    "category": "topic",
    "label": "How he defines the next-level scope",
    "reason": "What Ahmed means by “senior scope” and what success looks like in the next role, so the growth plan is anchored to concrete expectations rather than vague aspirations.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Stakeholder trust and influence gaps",
    "reason": "What stakeholder trust gaps he sees right now—could be visibility, expectations management, or hard-news conversations—and where he thinks he’s not yet landing at his level.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Where he’s still acting as an executor",
    "reason": "Whether Ahmed is temporarily pulled into tactical delivery due to pressure, or if there’s a confidence gap driving him to grab the work instead of moving it through others.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "Strategic ownership vs tactical firefighting",
    "reason": "What he’s saying yes and no to over the next 6–12 weeks, so his growth plan ties to strategic ownership and measurable outcomes, not just good habits.",
...
[
  ...
  {
    "alias": "q_current_scope_2",
    "label": "Current scope",
    "name": "What's feeling most solid in your role right now, Ahmed?",
    "description": "Surfaces the parts of his current scope that are stable before moving into stretch or change.",
    "purpose": "wellbeing",
    "stage": "anchor",
    "axis_effects": {
      "engagement": 1,
  ...
  {
    "alias": "q_tactical_pull",
    "label": "Tactical pull",
    "name": "Where are you getting pulled back into execution most often?",
    "description": "Makes the tactical-vs-strategic split concrete without assuming it is a problem.",
    "purpose": "competency",
    "stage": "anchor",
    "axis_effects": {
      "clarity": 3,
  ...
  {
    "alias": "q_next_level_scope",
    "label": "Next-level scope",
    "name": "What does senior scope mean to you in practice?",
    "description": "Asks him to define the next-level role in concrete terms rather than abstract ambition.",
    "purpose": "topic",
    "stage": "aspiration",
    "axis_effects": {
      "growth": 3,
  ...
  {
    "alias": "q_role_markers",
    "label": "Role markers",
    "name": "What would make it obvious to you that you're operating at the next level?",
    "description": "Gets specific signals, outcomes, and behaviors that define the destination.",
    "purpose": "topic",
    "stage": "aspiration",
    "axis_effects": {
      "growth": 3,
  ...
  {
    "alias": "q_influence_gaps",
    "label": "Influence gaps",
    "name": "Where do stakeholder conversations still not land the way you want?",
    "description": "Surfaces trust and influence gaps in a concrete work setting.",
    "purpose": "competency",
    "stage": "gap",
    "axis_effects": {
      "clarity": 3,
  ...
  {
    "alias": "q_visibility_pattern",
    "label": "Visibility pattern",
    "name": "What part of your visibility feels least consistent right now?",
    "description": "Explores whether the issue is exposure, messaging, or follow-through without diagnosing it upfront.",
    "purpose": "competency",
    "stage": "gap",
    "axis_effects": {
      "clarity": 1,
  ...
  {
    "alias": "q_trade_offs_ahead",
    "label": "Trade-offs ahead",
    "name": "What are you choosing not to own over the next six to twelve weeks?",
    "description": "Forces a real prioritisation conversation around strategic ownership and trade-offs.",
    "purpose": "topic",
    "stage": "investment",
    "axis_effects": {
      "clarity": 3,
  ...
  {
    "alias": "q_manager_support_8",
    "label": "Manager support",
    "name": "What kind of support from me would help you stay at the strategic level?",
    "description": "Opens the manager's role in protecting focus and reinforcing the growth path.",
    "purpose": "topic",
    "stage": "investment",
    "axis_effects": {
      "clarity": 1,
  ...
  {
    "alias": "q_first_move_6",
    "label": "First move",
    "name": "Given what we've covered, where do you want to focus first?",
    "description": "Closes by turning the conversation into one concrete next move.",
    "purpose": "topic",
    "stage": "commitment",
    "axis_effects": {
      "growth": 1,
