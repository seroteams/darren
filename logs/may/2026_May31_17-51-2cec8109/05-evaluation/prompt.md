...
[
  {
    ...
    "type": "Impact",
    "category": "competency",
    "label": "How she frames Senior-level impact and leverage",
    "reason": "Whether she can clearly articulate what moved because of her work, not just what she delivered, and where her leverage is coming from.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Influence and visibility with cross-functional stakeholders",
    "reason": "What she’s doing to build trust and raise signal with stakeholders, especially when results aren’t automatically noticed.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Handling cross-functional friction without stalling",
    "reason": "How she reduces friction at team boundaries—what she escalates, what she pre-wires, and how she keeps other teams in the loop.",
  ...
  },
  {
    ...
    "type": "Judgment",
    "category": "competency",
    "label": "Tradeoffs: execution depth vs strategic calls",
    "reason": "What calls she’s making on where to go deep in execution versus where to invest in influence, visibility, and early alignment for higher leverage.",
    "source": "best_practice",
    "known": true
  }
]
...
[
  ...
  },
  {
    ...
    "alias": "q_uneven_influence_3",
    "answer": "I get work done, yet I am not consistently shaping decisions early.",
    "skipped": false
  },
  {
    "question": "When did you last miss the chance to shape a decision early?",
    "alias": "q_early_decisions_3",
    "answer": "Some feedback has been about being clearer with non-technical partners.",
    "skipped": false
  },
  {
    "question": "What changed because of your work that would not have happened otherwise?",
    "alias": "q_impact_in_practice",
    "answer": "I tend to wait until analysis is complete before socializing direction.",
    "skipped": false
  },
  {
    "question": "What makes you hold direction until the analysis feels complete?",
    "alias": "q_socializing_direction",
    "answer": "That slows trust because stakeholders feel surprised late.",
    "skipped": false
  },
  {
    "question": "Stakeholders feeling surprised late — where does that pattern show up most?",
    "alias": "q_surprised_late_2",
  ...
  {
    "question": "Where do you choose to go deep instead of pulling others in earlier?",
    "alias": "q_leverage_choices",
    "answer": "Specific feedback checkpoints during projects would help me level up faster.",
    "skipped": false
  },
  {
    "question": "What is one change you will make in the next two weeks to raise your visibility?",
    "alias": "q_next_step_commitment",
