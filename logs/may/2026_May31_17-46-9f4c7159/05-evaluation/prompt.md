...
[
  {
    ...
    "type": "Impact",
    "category": "competency",
    "label": "Principal-level impact and leverage showing up",
    "reason": "What’s visible from his Principal scope on this team yet—could be steady delivery without enough leverage, or the impact is happening but not being named or measured clearly.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "reason": "Whether he’s operating on the new team’s expectations or old assumptions—worth clarifying what “good” looks like for Principal work here and how he’s interpreting it.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "competency",
    "label": "Cross-team trust and hard decisions",
    "reason": "What he’s doing to build trust beyond his immediate team and make judgment calls visible—Principal work often shows up in how he manages expectations and escalates hard news early.",
  ...
  },
  {
    ...
    "reason": "How they’re calibrating tradeoffs and deciding when to handle vs when to pull you in—at Principal level, the quality of calls is a primary differentiator in performance conversations.",
    "source": "best_practice",
    "known": true
  },
  {
    ...
    "reason": "Whether his “early alignment” is improving—notes suggest he asks very few questions, so it’s worth checking if he’s getting ahead of misunderstandings or still waiting for certainty before engaging.",
    "source": "signal",
    "known": true
  }
]
...
[
  ...
  {
    "question": "When you say 'highest-leverage work,' what work do you think that is here?",
    "alias": "q_highest_leverage_work_3",
    "answer": "I can describe Principal impact in general, but this team's bar still feels fuzzy.",
    "skipped": false
  },
  {
    "question": "describe rincipal impact — can you say more about what that means for you right now?",
    "alias": "q_thread_follow_2",
    "answer": "I have mostly stayed in my lane instead of forcing cross-team decisions.",
    "skipped": false
  },
  {
    "question": "Where do you think your leverage is most visible in the work today?",
    "alias": "q_visible_leverage_2",
    "answer": "I have made a few calls independently, but I still over-index on being safe.",
    "skipped": false
  },
  {
    "question": "When you say 'being safe,' what do you hold back from doing?",
    "alias": "q_being_safe",
    "answer": "I probably should ask for sharper feedback earlier than I do.",
    "skipped": false
  },
  {
    "question": "Sharper feedback earlier — what are you usually waiting for before you ask?",
    "alias": "q_sharper_feedback_3",
  ...
  {
    "question": "What tends to stop you from asking a question early?",
    "alias": "q_questioning_cadence",
    "answer": "I need explicit expectations for the next cycle so I can calibrate fast.",
    "skipped": false
  },
  {
    "question": "What would you want me to see differently by our next check-in?",
    "alias": "q_next_signal",
    "answer": "I will pick one recent deliverable and write down the decision rule I used before our next check-in.",
    "skipped": false
  }
]
```
  ...
  "clarity": {
    ...
    "history": [
      ...
      },
      {
        "q": "q_next_signal",
        "delta": 1,
        "answer_excerpt": "I will pick one recent deliverable and write down the decision rule I used before our next check-in."
      }
    ]
  },
  "growth": {
