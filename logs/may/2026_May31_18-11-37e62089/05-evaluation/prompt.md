...
[
  ...
  {
    "question": "You said 'less present in rituals' — what shifted there for you?",
  ...
  {
    "question": "What work do you think gets recognized here instead?",
    "alias": "q_recognized_work_4",
    "answer": "I want clearer criteria, not reassurance.",
    "skipped": false
  },
  {
    "question": "What concrete path forward feels real to you right now?",
    "alias": "q_concrete_path",
    "answer": "I can own bigger direction, but I need real authority to do it.",
    "skipped": false
  },
  {
    "question": "What support from me would make the biggest difference in the next couple of weeks?",
    "alias": "q_next_step_from_me_2",
    "answer": "If we can define the path precisely, I will commit to it.",
    "skipped": false
  },
  {
    "question": "What do you need from me to make the next couple of weeks steadier?",
