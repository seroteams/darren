...
[
  ...
  {
    "alias": "q_recognized_work_4",
    "name": "What work do you think gets recognized here instead?",
  ...
  {
    "alias": "q_next_step_from_me_2",
    "name": "What support from me would make the biggest difference in the next couple of weeks?",
...
```
I would start by naming one forum where I want clearer criteria, and what support I need to show up there.
```
...
[
  {
    "alias": "q_next_step_from_me_3",
    "label": "Next step from me",
    "name": "What support from me would make the biggest difference right now?",
    "description": "Ends with an open invitation for the employee to name the manager support that would help most.",
    "purpose": "wellbeing",
    "stage": "support",
    "axis_effects": {
      "wellbeing": 1,
