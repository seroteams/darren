...
- Turn just completed: 1 of 9
- Remaining budget (turns left after this one): 8
- Is final turn: false
...
{
  "alias": "q_landing_check_in_2",
  "label": "Landing check-in",
  "name": "What's felt most clear or unclear for you in week two, Riley?",
  "description": "Lets Riley set the current onboarding picture before the conversation gets specific.",
  "purpose": "wellbeing",
  "stage": "settling",
  "axis_effects": {
    "clarity": 1,
...
```
I am comfortable reading the services, but I am less sure how decisions are really made here.
```
...
[
  {
    "alias": "q_team_contact",
    "label": "Team contact",
    "name": "Who have you actually had enough live time with so far?",
    "description": "Surfaces whether he is getting enough direct contact to build the team map, not just reading it.",
    "purpose": "topic",
    "stage": "settling",
    "axis_effects": {
      "engagement": 1,
