...
- Turn just completed: 8 of 9
- Remaining budget (turns left after this one): 1
- Is final turn: true
...
```
If I know exactly what ownership I should take this month, I can contribute with more confidence.
```
...
[
  {
    "alias": "q_steady_next_steps_2",
    "label": "Steady next steps",
    "name": "What support should we line up before our next check-in?",
