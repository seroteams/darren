...
- Turn just completed: 7 of 9
- Remaining budget (turns left after this one): 2
- Is final turn: false
- Current stage hint (last question's stage): `blockers`
...
```json
{
  ...
  "name": "Which handoff details only become visible during live incidents?",
  "description": "Drills into the specific incident handoff gaps so the manager can make tacit operating norms explicit.",
  "purpose": "topic",
  "stage": "blockers",
  "axis_effects": {
    "clarity": 3,
...
```
A short weekly architecture review with someone senior would help me calibrate faster.
```
