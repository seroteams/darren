...
- Total turns: 9
- Reserved closer alias: q_next_decision
...
[
  ...
  },
  {
    ...
    "name": "When you say 'unwritten rules,' what are you still having to decode?",
    "answer": "I can draft plans, though I am not always sure when I should decide versus escalate.",
    "skipped": false
  },
  {
    "alias": "q_decide_vs_escalate",
    "name": "In which situations is decide versus escalate still hardest to judge?",
...
```json
{
  ...
  "name": "How do roadmap tradeoffs seem to get finalized from what you've seen so far?",
  "description": "Drills into her specific confusion about the tradeoff process before moving to support.",
  "purpose": "topic",
  "stage": "blockers",
  "axis_effects": {
    "clarity": 3,
...
[
  {
    ...
    "name": "What would make my support more useful for you this month?",
    "description": "Lets her name the guardrails, context, or escalation help she wants from her manager.",
    "purpose": "topic",
    "stage": "connection",
    "axis_effects": {
      "clarity": 1,
  ...
  {
    "alias": "q_next_decision_2",
    "label": "Next decision",
    "name": "What would you like to feel clearer on first over the next couple of weeks?",
    "description": "Closes by inviting her to name the first area of clarity to build next.",
    "purpose": "competency",
    "stage": "connection",
    "axis_effects": {
      "clarity": 1,
