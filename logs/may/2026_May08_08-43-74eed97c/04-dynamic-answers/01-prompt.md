...
6. **Arc position.**
   ...
   - **Final turn (`remaining_budget` = 1):** the last question must be a closer. It asks about actions, commitments, or what the employee is taking away — not a new topic. If a closer-type question exists in the remaining queue, surface it as the first item. If not, generate one: e.g. "What's the one thing you want to have moved before we next meet?" or "What do you need from me in the next two weeks?" Do NOT use the last turn to open a new concern.
...
[
  {
    ...
    "category": "wellbeing",
    "label": "Understanding why you're always running late",
    "reason": "Notes mention Carl is always late. Could be a workload issue, time management challenge, or something personal — worth exploring what might be behind this pattern.",
    "known": true
  },
  {
    "id": "priorities",
    ...
    "reason": "No specific signal — selected because this is a normal Bi-weekly check-in topic for a Lead UX Lead. Understanding current priorities ensures alignment with team and company goals.",
    "known": true
  },
  {
    "id": "energy",
    ...
    "category": "wellbeing",
    "label": "Checking in on your overall energy levels",
    "reason": "No specific signal — selected because this is a normal Bi-weekly check-in topic for a Lead UX Lead. Regularly assessing energy levels helps identify potential burnout or motivation dips.",
    "known": true
  },
  {
    "id": "team_connection",
    ...
    "category": "wellbeing",
    "label": "How you're feeling about team dynamics",
    "reason": "No specific signal — selected because this is a normal Bi-weekly check-in topic for a Lead UX Lead. Exploring team connection can surface any interpersonal issues affecting performance.",
    "known": true
  },
  {
    "id": "manager_support",
    ...
    "category": "topic",
    "label": "What more you need from me as your manager",
    "reason": "No specific signal — standard check-in hygiene. This opens the door for Carl to express any support needs that might help with his punctuality or other challenges.",
    "known": true
  }
]
```
...
[
  ...
  {
    "alias": "q_current_work_stressors",
    "label": "Current work stressors",
    "name": "What part of your workload feels like it's causing you to be late most often?",
    "description": "Explores the underlying causes of consistent lateness, potentially revealing workload or time management issues.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3
    }
  ...
  {
    "alias": "q_team_dynamics_6",
    "label": "Team dynamics",
    "name": "How are you feeling about the team dynamics right now?",
    "description": "Surfaces any interpersonal issues that might be affecting team performance or personal stress.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 1
    }
  ...
  {
    "alias": "q_support_needs_8",
    "label": "Support needs",
    "name": "What do you need from me right now to help with your current workload?",
    "description": "Opens up for Carl to express any specific support needs from the manager that could aid in managing workload or punctuality.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 1
    }
  ...
  {
    "alias": "q_energy_management_4",
    "label": "Energy management",
    "name": "What strategies are you using to maintain your energy levels throughout the week?",
    "description": "Probes for personal strategies in place to manage energy and avoid burnout.",
    "purpose": "wellbeing",
    "axis_effects": {
      "wellbeing": 3
    }
  ...
  {
    "alias": "q_role_clarity_5",
    "label": "Role clarity",
    "name": "How clear are you on your role and its current priorities?",
    "description": "Assesses Carl's understanding of his role and whether it aligns with team and company goals.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 3
    }
  ...
  {
    "alias": "q_growth_opportunities_12",
    "label": "Growth opportunities",
    "name": "Where do you see opportunities for growth in your current projects?",
    "description": "Encourages Carl to identify areas for personal and professional growth within his current role.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 3
    }
  ...
  {
    "alias": "q_project_prioritisation",
    "label": "Project prioritisation",
    "name": "What would you drop if you had to cut something from your workload this week?",
    "description": "Surfaces what Carl sees as low priority, which can help with workload management and focus.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 1
    }
  ...
  {
    "alias": "q_future_focus_2",
    "label": "Future focus",
    "name": "What are you most excited to tackle next after your current projects?",
    "description": "Identifies what Carl is looking forward to, shedding light on engagement and motivation.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 1,
      "engagement": 3
  ...
  {
    "alias": "q_managerial_effectiveness",
    "label": "Managerial effectiveness",
    "name": "What's one thing I could do differently to support your work better?",
    "description": "Invites feedback on management style and support effectiveness.",
    "purpose": "topic",
    "axis_effects": {
      "clarity": 1
    }
  ...
  {
    "alias": "q_session_closure",
    "label": "Session closure",
    "name": "What's the first concrete thing you want to have moved by our next conversation?",
    "description": "Encourages Carl to commit to a tangible action or goal before the next meeting.",
    "purpose": "competency",
    "axis_effects": {
      "growth": 1
    }
