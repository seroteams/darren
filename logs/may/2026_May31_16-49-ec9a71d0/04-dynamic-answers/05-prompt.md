...
[
  ...
  {
    "alias": "q_less_present_rituals",
    "name": "You said 'less present in rituals' — what changed there for you?",
    "answer": "After the promotion decision, I was not clear on what really needed to change.",
    "skipped": false
  },
  {
    "alias": "q_needed_change_clarity",
    "name": "When you say 'what needed to change' — what felt unclear to you?",
  ...
  {
    "alias": "q_mentoring_usefulness",
    "name": "You said mentoring is where you still feel useful — what is it giving you?",
...
{
  "alias": "q_mentoring_usefulness",
  "label": "Mentoring usefulness",
  "name": "You said mentoring is where you still feel useful — what is it giving you?",
  "description": "Drills into why mentoring stands out as the place he still feels useful, to surface what is missing elsewhere.",
  "purpose": "topic",
  "stage": "landing",
  "axis_effects": {
    "wellbeing": 3,
...
```
I am not sure the work I am doing is the work that gets recognized.
```
