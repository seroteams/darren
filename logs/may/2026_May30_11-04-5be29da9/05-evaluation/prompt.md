...
[
  ...
  {
    "question": "When you say 'heavier' — what was making it heavy day to day?",
    "alias": "q_heavier_than_sounded",
  ...
  },
  {
    ...
    "alias": "q_decision_bottlenecks_2",
  ...
  {
    "question": "Substantive feedback on key decisions — what's missing from it right now?",
    "alias": "q_decision_feedback",
    "answer": "I want clearer ownership boundaries so I am not default escalation.",
    "skipped": false
  },
  {
    "question": "Ownership boundaries — where is default escalation happening most right now?",
    "alias": "q_ownership_boundaries",
    "answer": "Next I want to hand off one stream end-to-end and stay out of the middle.",
    "skipped": false
  },
  {
    "question": "What would actually be useful from me over the next two weeks?",
