...
[
  ...
  },
  {
    ...
    "name": "When you say it was 'heavier' — what was making it heavy?",
    "answer": "Late nights came from carrying decision bottlenecks and final reviews.",
    "skipped": false
  },
  {
    "alias": "q_decision_bottlenecks_6",
    "name": "Decision bottlenecks — where are they stacking up most right now?",
  ...
  },
  {
    ...
    "name": "proud outcomes, pace — can you say more about what that means for you right now?",
    "answer": "I still do not get enough substantive feedback on key decisions.",
    "skipped": false
  },
  {
    "alias": "q_thread_follow_12",
    "name": "still enough substantive — can you say more about what that means for you right now?",
...
```
I want to focus first on unblocking the one dependency that is slowing the team the most this week.
```
