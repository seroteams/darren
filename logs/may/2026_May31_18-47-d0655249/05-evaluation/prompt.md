...
[
  {
    ...
    "reason": "Whether he’s getting the right sponsorship and visibility for the strategic work he’s doing, or staying in a safer lane after being passed over last cycle.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "reason": "What “good” looks like for a Lead in Growth & career plan is owning decisions end-to-end—so you can turn his execution into clear accountability and faster unblocking.",
  ...
  },
  {
    ...
    "category": "competency",
    "label": "Cross-functional impact and decision leverage",
    "reason": "What he can point to as measurable cross-functional outcomes—could be fewer last-minute surprises, more shared decisions, or stronger buy-in from product/engineering.",
    "source": "signal",
    "known": true
  },
  {
    ...
    "category": "topic",
    "label": "A concrete growth contract for the next cycle",
    "reason": "What he wants from this conversation should translate into a specific set of decision and influence commitments, not a generic development list.",
    "source": "best_practice",
    "known": true
  }
]
...
[
  ...
  {
    "question": "Political capital — where are you holding back right now?",
    "alias": "q_political_capital_5",
    "answer": "I can lead major initiatives, but I do not always translate that into visible strategic influence.",
    "skipped": false
  },
  {
    "question": "Visible strategic influence — what would that look like in practice for you?",
    "alias": "q_strategic_influence_4",
  ...
  {
    "question": "High-ambiguity forums — what about them makes you feel underprepared?",
    "alias": "q_ambiguity_forums_3",
    "answer": "I think I need to own a cross-org decision area, not just deliver strong design outcomes.",
    "skipped": false
  },
  {
    "question": "Cross-org decision area — which one would you want to own?",
    "alias": "q_cross_org_ownership",
  ...
  {
    "question": "Who is already backing your strategic work, and who is not yet there?",
    "alias": "q_sponsorship_picture",
    "answer": "I want milestones that show progress before the next cycle, not only retrospective feedback.",
    "skipped": false
  },
  {
    "question": "What is the one move you want to make before we next meet?",
    "alias": "q_next_commitment_5",
