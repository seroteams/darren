...
```json
{
  ...
  "focus_points": [
    { "id": "<catalogue id>", "label": "<your tailored label>", "reason": "<reason text>", "source": "signal" | "best_practice" }
  ]
}
```
</output_contract>
...
- `priorities` · "What's in flight this cycle." · "Standard bi-weekly anchor — he still needs air to surface what he's actually shipping, independent of the late-nights signal." · `best_practice`
...
- `energy` · "Motivation and pace vs three months ago." · "Notes mention slower PRs and quieter standups. Could be fatigue, disengagement, something personal, or just a quiet stretch — worth asking before assuming." · `signal`
