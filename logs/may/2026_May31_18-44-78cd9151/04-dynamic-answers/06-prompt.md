...
- Total turns: 9
- Reserved closer alias: q_useful_next_step
...
- Turn just completed: 6 of 9
- Remaining budget (turns left after this one): 3
- Is final turn: false
- Current stage hint (last question's stage): `orientation`
- Consecutive drills at current stage: 2
...
[
  {
    ...
    "name": "What has been most on your mind in your first two weeks here, Riley?",
  ...
  },
  {
    ...
    "name": "When you say 'how decisions are really made' — what part is least clear?",
  ...
  },
  {
    ...
    "name": "trace most request — can you say more about what that means for you right now?",
    "answer": "I have not been fully clear on who is on point for each domain when priorities conflict.",
    "skipped": false
  },
  {
    "alias": "q_ownership_map",
    "name": "What feels clearest to you about what you own right now?",
  ...
  },
  {
    ...
    "name": "What kinds of questions are sitting in that notes doc right now?",
...
{
  "alias": "q_escalate_vs_batch_2",
  "label": "Escalate vs batch",
  "name": "What would a useful escalate-versus-batch guide need to cover?",
  "description": "Drills into the specific escalation ambiguity he named so the manager can remove friction fast.",
  "purpose": "topic",
  "stage": "orientation",
  "axis_effects": {
    "clarity": 3,
...
```
The runbook helped, but some practical handoff details only show up during live incidents.
```
...
[
  {
    ...
    "label": "Context gaps",
    "name": "What context are you still waiting on before you change a design or make an architecture call?",
    "description": "Surfaces missing information that could quietly lead to rework or wrong assumptions.",
    "purpose": "competency",
    "stage": "blockers",
    "axis_effects": {
      "clarity": 3,
  ...
  {
    "alias": "q_incident_norms",
    "label": "Incident norms",
    "name": "How should you know when to escalate during an incident here?",
    "description": "Checks whether he understands the practical trigger points for escalation and support.",
    "purpose": "competency",
    "stage": "blockers",
    "axis_effects": {
      "clarity": 3,
  ...
  {
    "alias": "q_support_network_3",
    "label": "Support network",
    "name": "Who do you want to lean on first when you hit something unclear?",
    "description": "Identifies the people and channels that should become his default support path.",
    "purpose": "topic",
    "stage": "connection",
    "axis_effects": {
      "engagement": 1,
  ...
  },
  {
    ...
    "name": "What would make the next two weeks feel steadier for you, Riley?",
    "description": "Closes on concrete support or adjustments that would improve his onboarding momentum.",
    "purpose": "wellbeing",
    "stage": "connection",
    "axis_effects": {
      "wellbeing": 1,
