...
```json
{
  ...
  "label": "Landing check",
  "name": "What has been most on your mind in your first two weeks here, Riley?",
  "description": "Gives Riley room to set the agenda and surface what feels most present before narrowing in.",
  "purpose": "wellbeing",
  "stage": "settling",
  "axis_effects": {
    "wellbeing": 1,
...
[
  {
    "alias": "q_team_contact_3",
    "label": "Team contact",
    "name": "Who have you actually had the most useful direct contact with so far?",
    "description": "Surfaces whether his onboarding has been mostly async and where live context is still thin.",
    "purpose": "topic",
    "stage": "settling",
    "axis_effects": {
      "engagement": 1,
  ...
  },
  {
    "alias": "q_ask_early_2",
    "label": "Ask early",
    "name": "What questions do you think you should ask earlier here?",
    "description": "Reveals where he may be holding back from asking for context soon enough.",
    "purpose": "competency",
    "stage": "blockers",
    "axis_effects": {
      "clarity": 1,
