...
[
  ...
  {
    "question": "Execution details — where are you still getting pulled in most often?",
    "alias": "q_execution_details_2",
    "answer": "When conversations get political, I tend to retreat to what I can deliver directly.",
    "skipped": false
  },
  {
    "question": "Political conversations — what makes those moments hardest for you to stay in?",
  ...
  {
    "question": "Senior forums — what about those rooms makes you feel unprepared?",
  ...
  {
    "question": "What would you stop doing if you wanted to spend more time on strategic ownership?",
    "alias": "q_tradeoff_ask",
    "answer": "A clear growth contract with milestones would keep me accountable.",
    "skipped": false
  },
  {
    "question": "Given what we've covered, where do you want to start first?",
